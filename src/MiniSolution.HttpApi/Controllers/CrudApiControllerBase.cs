...
public abstract class CrudApplicationControllerBase<TAppService, TKey, TGetOutputDto, TGetListOutputDto, TGetListInputDto, TCreateOrUpdateInputDto>
    ...
    where TUpdateInputDto : class
{
    ...
    [HttpGet]
    public virtual Task<OutputResult<PagedOutputDto<TGetListOutputDto>>> GetListAsync(int page=1, int size=10, TGetListInputDto? model = null)
