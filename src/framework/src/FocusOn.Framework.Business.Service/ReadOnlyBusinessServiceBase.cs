...
public abstract class ReadOnlyBusinessServiceBase<TContext, TEntity, TKey> : ReadOnlyBusinessServiceBase<TContext, TEntity, TKey, TEntity>, IReadOnlyBusinessService<TKey, TEntity>
        where TContext : DbContext
    where TEntity : class
    where TKey : IEquatable<TKey>
{
    /// <summary>
    /// 初始化 <see cref="ReadOnlyBusinessServiceBase{TContext, TEntity, TKey}"/> 类的新实例。
    /// </summary>
    /// <param name="serviceProvider"></param>
    protected ReadOnlyBusinessServiceBase(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }
}
...
public abstract class ReadOnlyBusinessServiceBase<TContext, TEntity, TKey, TModel> : ReadOnlyBusinessServiceBase<TContext, TEntity, TKey, TModel, TModel>, IReadOnlyBusinessService<TKey, TModel>
        where TContext : DbContext
    where TEntity : class
    where TKey : IEquatable<TKey>
    where TModel : class
{
    /// <summary>
    /// 初始化 <see cref="ReadOnlyBusinessServiceBase{TContext, TEntity, TKey, TModel}"/> 类的新实例。
    /// </summary>
    /// <param name="serviceProvider"></param>
    protected ReadOnlyBusinessServiceBase(IServiceProvider serviceProvider) : base(serviceProvider)
    {
...
public abstract class ReadOnlyBusinessServiceBase<TContext, TEntity, TKey, TDetailOrListOutput, TListSearchInput> : ReadOnlyBusinessServiceBase<TContext, TEntity, TKey, TDetailOrListOutput, TDetailOrListOutput, TListSearchInput>
...
/// <typeparam name="TListSearchInput">列表查询的输入类型。</typeparam>
public abstract class ReadOnlyBusinessServiceBase<TContext, TEntity, TKey, TDetailOutput, TListOutput, TListSearchInput> : EfCoreBusinessServiceBase<TContext, TEntity, TKey>, IReadOnlyBusinessService<TKey, TDetailOutput, TListOutput, TListSearchInput>
    where TContext : DbContext
    where TEntity : class
    where TKey : IEquatable<TKey>
    where TListSearchInput : class
    ...
    where TDetailOutput : notnull
{
    ...
    /// <summary>
    /// 初始化 <see cref="ReadOnlyBusinessServiceBase{TContext, TEntity, TKey, TDetailOutput, TListOutput, TListSearchInput}"/> 类的新实例。
    /// </summary>
    protected ReadOnlyBusinessServiceBase(IServiceProvider serviceProvider) : base(serviceProvider)
    {
    }
